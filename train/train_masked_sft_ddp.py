#!/usr/bin/env python3
"""Full masked-SFT LoRA training of Qwen3.5-4B, 3-GPU DDP (torchrun).

Same machinery as train_patch_ddp.py; data is the clean-trajectory set
(only useful assistant steps). Init from the validation-round LoRA.
"""
import json
import math
import os
...
TRAIN_DATA = "data/swe_verify/sft_clean_rendered.jsonl"
OUTPUT_DIR = "checkpoints/qwen35-4b-lora-vl20-full"
INIT_LORA = "checkpoints/qwen35-4b-lora-vl20"
...
DONE_MARKER = "QWEN35-4B-LORA-VL20-FULL-DONE"
        ...
        while pos < len(my_order):
            ...
            if acc == GRAD_ACC:
                ...
                if step <= WARMUP:
                    ...
                    lr = LR * 0.5 * (1 + math.cos(math.pi * min(prog, 1.0)))
